...
#define BLE42_DEFAULTS_PHY   0
#define BLE50_LEGACY_PHY     1
#define BLE50_EXTEND_1M_PHY  2
#define BLE50_EXTEND_2M_PHY  3

#define CHOOSE_PHY   BLE50_EXTEND_2M_PHY
...
#if (CHOOSE_PHY == BLE42_DEFAULTS_PHY)
...
#elif (CHOOSE_PHY == BLE50_LEGACY_PHY || CHOOSE_PHY == BLE50_EXTEND_1M_PHY || CHOOSE_PHY == BLE50_EXTEND_2M_PHY)
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
...
#elif (CHOOSE_PHY == BLE50_LEGACY_PHY)
        esp_ble_gap_ext_adv_set_params(EXT_ADV_HANDLE, &ext_adv_params_legacy);
#elif (CHOOSE_PHY == BLE50_EXTEND_1M_PHY)
        esp_ble_gap_ext_adv_set_params(EXT_ADV_HANDLE, &ext_adv_params_1M);
#elif (CHOOSE_PHY == BLE50_EXTEND_2M_PHY)
    ...
    case ESP_GATTS_CONNECT_EVT: {
        ...
        conn_params.max_int = 30;    // max_int = 0x20*1.25ms = 40ms
        conn_params.min_int = 30;    // min_int = 0x10*1.25ms = 20ms
...
#if (CHOOSE_PHY == BLE50_EXTEND_2M_PHY)
